NDefines = {
	...
	NGameplay = {
		...
		REBELS_POWER_THRESHOLD 				= 0.2, 		-- A Threshold that controls when rebels think they have a chance, Higher = more unwilling
...
--		ETHOS_UNIFORM						= 25,	-- Uniform ethos results in this opinion value
		...
		POP_FACTION_SUPPORT_INCREASE		= 0.15,	-- If roll( 100 ) < value calculated above, increase factions' support with this
		...
		WAR_VASSALIZATION_PER_POP			= 15.0,	-- Influence cost to vassalize someone scaled with pop amount
		WAR_RELEASE_PER_POP					= 5.0,	-- Influence cost to release a vassal scaled with pop amount
		...
		PLANET_ARMIES_LIMIT						= 15,	-- Maximum number of troops per planet
		...
		XENOPHOBIA_SAME_SPECIES_CLASS_MULT  	= 1, -- Same Species Class: All Xenophobia and Xenophilia happiness and opinion effects are multiplied by this
		XENOPHOBIA_SUBSPECIES_MULT  			= 0.50, -- Subspecies: All Xenophobia and Xenophilia happiness and opinion effects are multiplied by this
		XENOPHOBIA_ROBOT_MULT  					= 0.50, -- Robots and Synthetics: All Xenophobia and Xenophilia happiness and opinion effects are multiplied by this
		XENOPHOBIA_CLIENT_PATRON_MULT  			= 0.50, -- Uplifed vs Uplifter: All Xenophobia and Xenophilia happiness and opinion effects are multiplied by this
		XENOPHOBIA_ALIEN_OVERLORDS_MULT  		= 4, 	-- Unhappiness effect Multiplier for Xenophobe Pops within Alien empires
	...
	NPop = {
		...
		MIN_HABITABILITY_TO_MIGRATE			= 0.3,		-- Will not migrate to planets with habitability under this
		MIGRATION_SPEED						= 0.05,		-- Monthly migration speed of pops: when the pop has reached a migration progress of 1, it will be moved
		WAS_ENSLAVED_LENGTH_DAYS			= 9125,		-- Number of days after emancipation a pop is angry for being enslaved
		...
		MAX_REVOLT_HAPPINESS 			= 0.5,		-- Maximum happiness for revolt risk
		...
		WAS_PURGED_LENGTH_DAYS				= 36500,	-- Number of days after purging a pop is angry for being genocided
	...
	NEconomy = {
		...
		FLEET_UPGRADE_TIME_COST_MULT		= 0.15,		-- Upgrade fleet cost
